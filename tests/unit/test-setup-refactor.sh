...
if [[ "${1:-}" == plugin && "${2:-}" == install ]]; then
  ...
  printf "%s\n" "${3:-}" > "${FAKE_CLAUDE_LAST_PLUGIN_FILE:?}"
...
_isp_run_case() { # <name> <selected> <list> <list-rc> <market-rc> <install-rc> <cli> [dry-run] [update] [post-mode] [record-rc] [prior-manifest-plugins] [list-fail-once] [marketplace-plugin]
...

{
  ...
  _isp_run_case marketplace-adds-target "security-guidance" "" \
    0 0 0 true false false auto 0 "" false \
    security-guidance@claude-plugins-official
  _case="$_ISP_DIR/state/marketplace-adds-target"
...

{
  ...
  for _post_mode in no-op wrong-marketplace wrong-scope \
    ...
    _isp_run_case "post-$_post_mode" "security-guidance" "" \
      0 0 0 true false false "$_post_mode"
    _case="$_ISP_DIR/state/post-$_post_mode"
    _marker="$_case/home/.claude/.starter-kit-plugin-provenance.json"
  ...
  _isp_run_case post-dependency "security-guidance" \
    $'❯ existing-plugin@claude-plugins-official\n  Scope: user' \
    0 0 0 true false false extra
  _case="$_ISP_DIR/state/post-dependency"
  _marker="$_case/home/.claude/.starter-kit-plugin-provenance.json"
...

{
  ...
  _isp_run_case manual-after-failure "security-guidance" "" \
    0 0 9 true
  _case="$_ISP_DIR/state/manual-after-failure"
  _marker="$_case/home/.claude/.starter-kit-plugin-provenance.json"
  if [[ "$(cat "$_case/rc.txt")" == 1 ]] \
    && jq -e '.installed_by_kit == [] and .pending_install_by_kit == [
      "security-guidance@claude-plugins-official"]' "$_marker" >/dev/null; then
  ...
  : > "$_case/install-seen"
  _isp_run_case manual-after-failure "security-guidance" "" 0 0 0 true
...

{
  ...
  _isp_run_case pending-project "security-guidance" "" 0 0 9 true
  _case="$_ISP_DIR/state/pending-project"
  _marker="$_case/home/.claude/.starter-kit-plugin-provenance.json"
  ...
  _isp_run_case pending-project "security-guidance" \
    $'❯ security-guidance@claude-plugins-official\n  Scope: project' \
    0 0 0 true
...

{
  ...
  _isp_run_case update-existing "security-guidance" \
    $'❯ security-guidance@claude-plugins-official\n  Scope: user' \
    0 0 0 true false true
  _case="$_ISP_DIR/state/update-existing"
  if grep -qx \
      "plugin install security-guidance@claude-plugins-official --scope user" \
      "$_case/calls.log" \
    && [[ ! -e "$_case/home/.claude/.starter-kit-plugin-provenance.json" ]] \
...

{
  ...
  _isp_run_case legacy-update "security-guidance" \
    $'❯ security-guidance@claude-plugins-official\n  Scope: user' \
    0 0 0 true false true auto 0 \
    "security-guidance,code-review@third-party"
  _case="$_ISP_DIR/state/legacy-update"
  if grep -qx \
      "plugin install security-guidance@claude-plugins-official --scope user" \
      "$_case/calls.log" \
    && [[ "$(cat "$_case/rc.txt")" == 0 ]] \
...

{
  ...
  _isp_run_case legacy-wrong-market "security-guidance" \
    $'❯ security-guidance@claude-plugins-official\n  Scope: user' \
    0 0 0 true false true auto 0 "security-guidance@third-party"
  _case="$_ISP_DIR/state/legacy-wrong-market"
  if grep -qx \
      "plugin install security-guidance@claude-plugins-official --scope user" \
      "$_case/calls.log" \
    && [[ "$(cat "$_case/rc.txt")" == 0 ]] \
...

{
  ...
  _isp_run_case project-only "security-guidance" \
    $'❯ security-guidance@claude-plugins-official\n  Scope: project' \
    0 0 0 true
  _case="$_ISP_DIR/state/project-only"
  _marker="$_case/home/.claude/.starter-kit-plugin-provenance.json"
  if grep -qx \
      "plugin install security-guidance@claude-plugins-official --scope user" \
      "$_case/calls.log" \
...

{
  ...
  _isp_run_case provenance-retry "security-guidance" "" \
    0 0 0 true false true auto 17
  _case="$_ISP_DIR/state/provenance-retry"
  _marker="$_case/home/.claude/.starter-kit-plugin-provenance.json"
...

{
  ...
  _isp_run_case provenance-repair "security-guidance" "" \
    0 0 0 true false true auto 17
  _case="$_ISP_DIR/state/provenance-repair"
  _marker="$_case/home/.claude/.starter-kit-plugin-provenance.json"
  if [[ "$(cat "$_case/rc.txt")" == 1 ]] \
    && jq -e '.installed_by_kit == [] and .verified_commit_by_kit == [
      "security-guidance@claude-plugins-official"]' \
...

{
  ...
  _schema_dir="$_ISP_DIR/state/schema"
  mkdir -p "$_schema_dir"
  if (
...

{
  ...
  _platform_root="$_ISP_DIR/state/platform-modes"
...

{
  ...
  _lock_failure_root="$_ISP_DIR/state/lock-failure"
...

{
  ...
  _dead_lock_root="$_ISP_DIR/state/dead-lock"
  _live_lock_root="$_ISP_DIR/state/live-lock"
  _bad_lock_root="$_ISP_DIR/state/bad-lock"
...

{
  ...
  _transition_root="$_ISP_DIR/state/transitions/home/.claude"
  _cancel_root="$_ISP_DIR/state/cancel/home/.claude"
...

{
  ...
  _idempotent_root="$_ISP_DIR/state/idempotent/home/.claude"
  _untracked_root="$_ISP_DIR/state/untracked/home/.claude"
...

{
  ...
  _isp_run_case list-failed-update "security-guidance" "untrusted" \
    7 0 0 true false true
  _isp_run_case install-failed "security-guidance" "" 0 0 9 true
  _isp_run_case list-failed-extra "security-guidance" "" \
    7 0 0 true false false extra
  _isp_run_case list-failed-scope "security-guidance" "" \
    7 0 0 true false false wrong-scope
  _isp_run_case list-install-failed "security-guidance" "" \
    7 0 9 true false false auto 0 "" true
  _failed_marker="$_ISP_DIR/state/install-failed/home/.claude/.starter-kit-plugin-provenance.json"
  if ! grep -q "plugin install security-guidance@claude-plugins-official" \
    ...
    && ! grep -q "plugin install security-guidance@claude-plugins-official" \
      "$_ISP_DIR/state/list-failed-update/calls.log" \
    && [[ ! -e "$_ISP_DIR/state/list-failed-update/home/.claude/.starter-kit-plugin-provenance.json" ]] \
    && [[ "$(cat "$_ISP_DIR/state/list-failed/rc.txt")" == 1 ]] \
    && [[ "$(cat "$_ISP_DIR/state/list-failed-update/rc.txt")" == 1 ]] \
    && [[ "$(cat "$_ISP_DIR/state/list-failed-extra/rc.txt")" == 1 ]] \
    && [[ "$(cat "$_ISP_DIR/state/list-failed-scope/rc.txt")" == 1 ]] \
    && [[ "$(cat "$_ISP_DIR/state/list-install-failed/rc.txt")" == 1 ]] \
    && [[ ! -e "$_ISP_DIR/state/list-failed-extra/home/.claude/.starter-kit-plugin-provenance.json" ]] \
    && [[ ! -e "$_ISP_DIR/state/list-failed-scope/home/.claude/.starter-kit-plugin-provenance.json" ]] \
    && grep -q "plugin install security-guidance@claude-plugins-official" \
      "$_ISP_DIR/state/list-install-failed/calls.log" \
    && jq -e '.installed_by_kit == [] and .pending_install_by_kit == [
      "security-guidance@claude-plugins-official"]' \
      "$_ISP_DIR/state/list-install-failed/home/.claude/.starter-kit-plugin-provenance.json" \
      >/dev/null \
    && jq -e '.installed_by_kit == [] and .pending_install_by_kit == [
      "security-guidance@claude-plugins-official"]' \
      "$_failed_marker" >/dev/null \
    && [[ "$(cat "$_ISP_DIR/state/install-failed/rc.txt")" == 1 ]]; then
    pass "$test_name"
  else
    fail "$test_name"
  fi
...
rm -rf "$_ISP_DIR"
unset _ISP_DIR _ISP_FIXED_PATH _case _marker _mode _before _after _first_pending
