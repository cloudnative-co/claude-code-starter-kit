...
| `/parallel` | Git Worktree を使った並列エージェント実行 |
| `/handover` | セッション引き継ぎドキュメントの生成 |
| `/cross-review` | クロスモデルコードレビュー（Claude + Codex） |
...
| ドキュメントサイズガード | CLAUDE.md/AGENTS.md の肥大化を警告 |
| ドキュメント鮮度ガード | コミット時にドキュメントの鮮度をチェック |
